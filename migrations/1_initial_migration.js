const Token = artifacts.require("LotteryToken");
...
module.exports = async function (deployer,network,accounts) {
  ...
  let routerInstance = await Router.at('0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3');
  let supply = await tokenInstance.totalSupply();
  await tokenInstance.approve(routerInstance.address,BigInt(supply),{from: accounts[0]});
